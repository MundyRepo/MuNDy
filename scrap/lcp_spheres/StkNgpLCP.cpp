...
inline void randomize_positions(Mesh &mesh, Field &coords_field,  //
                                ...
                                const mundy::Vector3d &domain_high, const stk::mesh::Selector &selector,
...
int main(int argc, char **argv) {
  ...
  Kokkos::initialize(argc, argv);
  {
    ...
    const mundy::Vector3d domain_low(0.0, 0.0, 0.0);
    const mundy::Vector3d domain_high(box_size, box_size, box_size);
