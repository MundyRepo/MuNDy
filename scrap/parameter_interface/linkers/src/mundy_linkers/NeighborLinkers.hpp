...
/// agent.
class NeighborLinkers : public mundy::agents::RankedAssembly<mundy::utils::make_string_literal("NEIGHBOR_LINKERS"),
 ...
 public:
  ...
  static inline std::shared_ptr<mundy::meta::MeshReqs> get_mesh_requirements() {
    ...
    return mundy::agents::RankedAssembly<mundy::utils::make_string_literal("NEIGHBOR_LINKERS"),
