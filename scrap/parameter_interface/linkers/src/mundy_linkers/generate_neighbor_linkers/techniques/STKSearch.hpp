  ...
  static Teuchos::ParameterList get_valid_fixed_params() {
    static Teuchos::ParameterList default_parameter_list =
        Teuchos::ParameterList()
            .set("valid_source_entity_part_names", mundy::utils::make_string_array(universal_part_name_),
                 "Name of the source parts associated with this pairwise meta method.")
            .set("valid_target_entity_part_names", mundy::utils::make_string_array(universal_part_name_),
                 "Name of the target parts associated with this pairwise meta method.")
            .set("specialized_neighbor_linkers_part_names",
                 mundy::utils::make_string_array(default_specialized_neighbor_linkers_part_name_),
