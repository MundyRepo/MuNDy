...
KOKKOS_FUNCTION Vector3<Scalar> map_body_frame_normal_to_ellipsoid(
    const AVector3<Scalar, Accessor, OwnershipType>& body_frame_nhat, Scalar r1, Scalar r2, Scalar r3) {
...
KOKKOS_FUNCTION Vector3<Scalar> map_surface_normal_to_foot_point_on_ellipsoid(
    const AVector3<Scalar, Accessor1, OwnershipType1>& lab_frame_ellipsoid_nhat,
    const AQuaternion<Scalar, Accessor2, OwnershipType2>& orientation,
    const AVector3<Scalar, Accessor3, OwnershipType3>& center, Scalar r1, Scalar r2, Scalar r3) {
...
template <typename Scalar, typename Accessor1, typename Accessor2, typename Accessor3, typename OwnershipType1,
          typename OwnershipType2, typename OwnershipType3>
KOKKOS_FUNCTION Vector3<Scalar> map_surface_normal_to_foot_point_on_ellipsoid(
    const AVector<Scalar, 2, Accessor1, OwnershipType1>& theta_phi,
    const AQuaternion<Scalar, Accessor2, OwnershipType2>& orientation,
    const AVector3<Scalar, Accessor3, OwnershipType3>& center, Scalar r1, Scalar r2, Scalar r3) {
...
class EllipsoidPointObjective {
 public:
  KOKKOS_FUNCTION
  EllipsoidPointObjective(const AVector3<Scalar, Accessor1, OwnershipType1>& center,
                          const AQuaternion<Scalar, Accessor2, OwnershipType2>& orientation, const Scalar r1,
                          const Scalar r2, const Scalar r3, const AVector3<Scalar, Accessor3, OwnershipType3>& point)
 ...
 private:
  const AVector3<Scalar, Accessor1, OwnershipType1>& center_;
  const AQuaternion<Scalar, Accessor2, OwnershipType2>& orientation_;
  const Scalar r1_;
  const Scalar r2_;
  const Scalar r3_;
  const AVector3<Scalar, Accessor3, OwnershipType3>& point_;
};
...
class EllipsoidEllipsoidObjective {
 public:
  KOKKOS_FUNCTION
  EllipsoidEllipsoidObjective(const AVector3<Scalar, Accessor1, OwnershipType1>& center0,
                              const AQuaternion<Scalar, Accessor2, OwnershipType2>& orientation0, const Scalar r1_0,
                              const Scalar r2_0, const Scalar r3_0,
                              const AVector3<Scalar, Accessor3, OwnershipType3>& center1,
                              const AQuaternion<Scalar, Accessor4, OwnershipType4>& orientation1, const Scalar r1_1,
 ...
 private:
  const AVector3<Scalar>& center0_;
  const AQuaternion<Scalar>& orientation0_;
  const Scalar r1_0_;
  const Scalar r2_0_;
  const Scalar r3_0_;
  const AVector3<Scalar>& center1_;
  const AQuaternion<Scalar>& orientation1_;
  const Scalar r1_1_;
  const Scalar r2_1_;
  const Scalar r3_1_;
};
...
KOKKOS_FUNCTION Scalar shared_normal_ssd_between_ellipsoids(
    const AVector3<Scalar, Accessor1, OwnershipType1>& center0,
    const AQuaternion<Scalar, Accessor2, OwnershipType2>& orientation0, const Scalar r1_0, const Scalar r2_0,
    const Scalar r3_0, const AVector3<Scalar, Accessor3, OwnershipType3>& center1,
    const AQuaternion<Scalar, Accessor4, OwnershipType4>& orientation1, const Scalar r1_1, const Scalar r2_1,
    const Scalar r3_1, AVector3<Scalar, Accessor5, OwnershipType5>& closest_point0,
    AVector3<Scalar, Accessor6, OwnershipType6>& closest_point1,
    AVector3<Scalar, Accessor7, OwnershipType7>& shared_normal0,
    AVector3<Scalar, Accessor8, OwnershipType8>& shared_normal1) {
  // Setup the minimization
  // Note, the actual error is not guaranteed to be less than min_objective_delta due to the use of approximate
  // derivatives. Instead, we saw that the error was typically less than the square root of min_objective_delta.
  const Scalar min_objective_delta = 1e-7;
