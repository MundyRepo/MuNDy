...
template <ValidPointType PointT, ValidVector3Type Vector3T>
  MUNDY_REQUIRES(std::is_same_v<typename PointT::scalar_t, typename Vector3T::scalar_t>)
...
template <ValidLineType LineT, ValidVector3Type Vector3T>
  MUNDY_REQUIRES(std::is_same_v<typename LineT::scalar_t, typename Vector3T::scalar_t>)
...
template <ValidLineSegmentType LineSegmentT, ValidVector3Type Vector3T>
  MUNDY_REQUIRES(std::is_same_v<typename LineSegmentT::scalar_t, typename Vector3T::scalar_t>)
...
template <ValidVSegmentType VSegmentT, ValidVector3Type Vector3T>
  MUNDY_REQUIRES(std::is_same_v<typename VSegmentT::scalar_t, typename Vector3T::scalar_t>)
...
template <ValidCircle3DType Circle3DT, ValidVector3Type Vector3T>
  MUNDY_REQUIRES(std::is_same_v<typename Circle3DT::scalar_t, typename Vector3T::scalar_t>)
...
template <ValidAABBType AABBT, ValidVector3Type Vector3T>
  MUNDY_REQUIRES(std::is_same_v<typename AABBT::scalar_t, typename Vector3T::scalar_t>)
...
template <ValidSphereType SphereT, ValidVector3Type Vector3T>
  MUNDY_REQUIRES(std::is_same_v<typename SphereT::scalar_t, typename Vector3T::scalar_t>)
...
template <ValidSpherocylinderType SpherocylinderT, ValidVector3Type Vector3T>
  MUNDY_REQUIRES(std::is_same_v<typename SpherocylinderT::scalar_t, typename Vector3T::scalar_t>)
...
template <ValidSpherocylinderSegmentType SpherocylinderSegmentT, ValidVector3Type Vector3T>
  MUNDY_REQUIRES(std::is_same_v<typename SpherocylinderSegmentT::scalar_t, typename Vector3T::scalar_t>)
...
template <ValidRingType RingT, ValidVector3Type Vector3T>
  MUNDY_REQUIRES(std::is_same_v<typename RingT::scalar_t, typename Vector3T::scalar_t>)
...
template <ValidEllipsoidType EllipsoidT, ValidVector3Type Vector3T>
  MUNDY_REQUIRES(std::is_same_v<typename EllipsoidT::scalar_t, typename Vector3T::scalar_t>)
...
template <ValidPointType PointT, ValidQuaternionType QuaternionT>
  MUNDY_REQUIRES(std::is_same_v<typename PointT::scalar_t, typename QuaternionT::scalar_t>)
...
template <ValidLineType LineT, ValidQuaternionType QuaternionT>
  MUNDY_REQUIRES(std::is_same_v<typename LineT::scalar_t, typename QuaternionT::scalar_t>)
...
template <ValidLineSegmentType LineSegmentT, ValidQuaternionType QuaternionT>
  MUNDY_REQUIRES(std::is_same_v<typename LineSegmentT::scalar_t, typename QuaternionT::scalar_t>)
...
template <ValidVSegmentType VSegmentT, ValidQuaternionType QuaternionT>
  MUNDY_REQUIRES(std::is_same_v<typename VSegmentT::scalar_t, typename QuaternionT::scalar_t>)
...
template <ValidCircle3DType Circle3DT, ValidQuaternionType QuaternionT>
  MUNDY_REQUIRES(std::is_same_v<typename Circle3DT::scalar_t, typename QuaternionT::scalar_t>)
...
template <ValidAABBType AABBT, ValidQuaternionType QuaternionT>
  MUNDY_REQUIRES(std::is_same_v<typename AABBT::scalar_t, typename QuaternionT::scalar_t>)
...
template <ValidSphereType SphereT, ValidQuaternionType QuaternionT>
  MUNDY_REQUIRES(std::is_same_v<typename SphereT::scalar_t, typename QuaternionT::scalar_t>)
...
template <ValidSpherocylinderType SpherocylinderT, ValidQuaternionType QuaternionT>
  MUNDY_REQUIRES(std::is_same_v<typename SpherocylinderT::scalar_t, typename QuaternionT::scalar_t>)
...
template <ValidSpherocylinderSegmentType SpherocylinderSegmentT, ValidQuaternionType QuaternionT>
  MUNDY_REQUIRES(std::is_same_v<typename SpherocylinderSegmentT::scalar_t, typename QuaternionT::scalar_t>)
...
template <ValidRingType RingT, ValidQuaternionType QuaternionT>
  MUNDY_REQUIRES(std::is_same_v<typename RingT::scalar_t, typename QuaternionT::scalar_t>)
...
template <ValidEllipsoidType EllipsoidT, ValidQuaternionType QuaternionT>
  MUNDY_REQUIRES(std::is_same_v<typename EllipsoidT::scalar_t, typename QuaternionT::scalar_t>)
