...
/// \brief Performance test the use of mundy::core::reference_wrapper vs explicit references in a workspace struct.
...
// Mundy
#include <mundy_core/reference_wrapper.hpp>  // for mundy::core::reference_wrapper, mundy::core::ref

using scalar_t = double;
using vec_t = std::vector<scalar_t>;

struct WorkspaceWrapper {
  mundy::core::reference_wrapper<scalar_t> x;
  mundy::core::reference_wrapper<scalar_t> y;
