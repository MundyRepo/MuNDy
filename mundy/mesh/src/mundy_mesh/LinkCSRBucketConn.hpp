...
namespace impl {
// clang-format off
template <typename MemSpace> KOKKOS_INLINE_FUNCTION       int& get_dirty_flag(      LinkCSRBucketConnT<MemSpace>& bucket_conn);
template <typename MemSpace> KOKKOS_INLINE_FUNCTION const int& get_dirty_flag(const LinkCSRBucketConnT<MemSpace>& bucket_conn);
template <typename MemSpace> KOKKOS_INLINE_FUNCTION       unsigned& get_total_num_connected_links(      LinkCSRBucketConnT<MemSpace>& bucket_conn);
template <typename MemSpace> KOKKOS_INLINE_FUNCTION const unsigned& get_total_num_connected_links(const LinkCSRBucketConnT<MemSpace>& bucket_conn);
template <typename MemSpace> KOKKOS_INLINE_FUNCTION       Kokkos::View<unsigned*, MemSpace>& get_num_connected_links(      LinkCSRBucketConnT<MemSpace>& bucket_conn);
template <typename MemSpace> KOKKOS_INLINE_FUNCTION const Kokkos::View<unsigned*, MemSpace>& get_num_connected_links(const LinkCSRBucketConnT<MemSpace>& bucket_conn);
template <typename MemSpace> KOKKOS_INLINE_FUNCTION       Kokkos::View<unsigned*, MemSpace>& get_sparse_connectivity_offsets(      LinkCSRBucketConnT<MemSpace>& bucket_conn);
template <typename MemSpace> KOKKOS_INLINE_FUNCTION const Kokkos::View<unsigned*, MemSpace>& get_sparse_connectivity_offsets(const LinkCSRBucketConnT<MemSpace>& bucket_conn);
template <typename MemSpace> KOKKOS_INLINE_FUNCTION       Kokkos::View<stk::mesh::Entity*, MemSpace>& get_sparse_connectivity(      LinkCSRBucketConnT<MemSpace>& bucket_conn);
template <typename MemSpace> KOKKOS_INLINE_FUNCTION const Kokkos::View<stk::mesh::Entity*, MemSpace>& get_sparse_connectivity(const LinkCSRBucketConnT<MemSpace>& bucket_conn);
}  // namespace impl
...
class LinkCSRBucketConnT {  // Raw data in any space.
 public:
  ...
  // clang-format off
  KOKKOS_INLINE_FUNCTION size_t bucket_id() const noexcept { return bucket_id_; }
  KOKKOS_INLINE_FUNCTION unsigned size() const noexcept { return bucket_size_; }
  KOKKOS_INLINE_FUNCTION unsigned capacity() const noexcept { return bucket_capacity_; }
  KOKKOS_INLINE_FUNCTION stk::mesh::EntityRank bucket_rank() const noexcept { return bucket_rank_; }
  KOKKOS_INLINE_FUNCTION unsigned total_num_connected_links() const noexcept { return total_num_connected_links_; }
  // clang-format on
...
// clang-format off
template <typename MemSpace> KOKKOS_INLINE_FUNCTION       int& get_dirty_flag(      LinkCSRBucketConnT<MemSpace>& bucket_conn) { return bucket_conn.dirty_; }
template <typename MemSpace> KOKKOS_INLINE_FUNCTION const int& get_dirty_flag(const LinkCSRBucketConnT<MemSpace>& bucket_conn) { return bucket_conn.dirty_; }
template <typename MemSpace> KOKKOS_INLINE_FUNCTION       unsigned& get_total_num_connected_links(      LinkCSRBucketConnT<MemSpace>& bucket_conn) { return bucket_conn.total_num_connected_links_; }
template <typename MemSpace> KOKKOS_INLINE_FUNCTION const unsigned& get_total_num_connected_links(const LinkCSRBucketConnT<MemSpace>& bucket_conn) { return bucket_conn.total_num_connected_links_; }
template <typename MemSpace> KOKKOS_INLINE_FUNCTION       Kokkos::View<unsigned*, MemSpace>& get_num_connected_links(      LinkCSRBucketConnT<MemSpace>& bucket_conn) { return bucket_conn.num_connected_links_; }
template <typename MemSpace> KOKKOS_INLINE_FUNCTION const Kokkos::View<unsigned*, MemSpace>& get_num_connected_links(const LinkCSRBucketConnT<MemSpace>& bucket_conn) { return bucket_conn.num_connected_links_; }
template <typename MemSpace> KOKKOS_INLINE_FUNCTION       Kokkos::View<unsigned*, MemSpace>& get_sparse_connectivity_offsets(      LinkCSRBucketConnT<MemSpace>& bucket_conn) { return bucket_conn.sparse_connectivity_offsets_; }
template <typename MemSpace> KOKKOS_INLINE_FUNCTION const Kokkos::View<unsigned*, MemSpace>& get_sparse_connectivity_offsets(const LinkCSRBucketConnT<MemSpace>& bucket_conn) { return bucket_conn.sparse_connectivity_offsets_; }
template <typename MemSpace> KOKKOS_INLINE_FUNCTION       Kokkos::View<stk::mesh::Entity*, MemSpace>& get_sparse_connectivity(      LinkCSRBucketConnT<MemSpace>& bucket_conn) { return bucket_conn.sparse_connectivity_; }
template <typename MemSpace> KOKKOS_INLINE_FUNCTION const Kokkos::View<stk::mesh::Entity*, MemSpace>& get_sparse_connectivity(const LinkCSRBucketConnT<MemSpace>& bucket_conn) { return bucket_conn.sparse_connectivity_; }
// clang-format on
