...
#ifndef MUNDY_MESH_LINKDECLARATIONREQUESTS_HPP_
#define MUNDY_MESH_LINKDECLARATIONREQUESTS_HPP_

/// \file LinkDeclarationRequests.hpp
...
class LinkDeclarationRequestsT {  // Raw data in any space
 ...
 private:
  ...
  using SizeDualView = NgpViewT<size_t, MemSpace>;
  using RequestsDualView = NgpViewT<stk::mesh::Entity**, MemSpace>;
...
#endif  // MUNDY_MESH_LINKDECLARATIONREQUESTS_HPP_
