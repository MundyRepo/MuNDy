...
// Mundy
#include <mundy_utils/StringLiteral.hpp>  // for mundy::utils::StringLiteral, mundy::utils::make_string_literal
...
class NgpRequestEntitiesT {
 public:
  ...
  KOKKOS_INLINE_FUNCTION FutureEntity request(our_size_t ticket, int owning_proc) {
    constexpr auto name = utils::make_string_literal("NgpRequestEntitiesT::request");
  ...
  KOKKOS_INLINE_FUNCTION stk::mesh::Entity get_entity(our_size_t ticket) const {
    constexpr auto name = utils::make_string_literal("NgpRequestEntitiesT::get_requested_entity");
    assert_ticket_out_of_range<name>(ticket);
 ...
 private:
  ...
  using request_view_t = utils::NgpViewT<EntityRequest*, NgpMemSpace>;
  request_view_t requests_;

  using entity_view_t = utils::NgpViewT<stk::mesh::Entity*, NgpMemSpace>;
...
class NgpRequestConnectionT {
 public:
  ...
  KOKKOS_INLINE_FUNCTION FutureConnection request(our_size_t ticket,
                                                  utils::variant<stk::mesh::Entity, FutureEntity> from_entity,
                                                  utils::variant<stk::mesh::Entity, FutureEntity> to_entity) {
    constexpr auto name = utils::make_string_literal("NgpRequestConnectionT::request");
    assert_active_space<name>();
    assert_ticket_out_of_range<name>(ticket);
 ...
 private:
  ...
  using request_view_t = utils::NgpViewT<ConnectionRequest*, NgpMemSpace>;
  request_view_t requests_;
  //@}
};  // NgpRequestConnectionT
...
class NgpDestroyEntityT {
 public:
  ...
  KOKKOS_INLINE_FUNCTION FutureDestroyEntity destroy(our_size_t ticket, stk::mesh::Entity entity) {
    constexpr auto name = utils::make_spring_literal("NgpDestroyEntityT::destroy");
    assert_active_space<name>();
    assert_ticket_out_of_range<name>(ticket);
 ...
 private:
  ...
  using request_view_t = utils::NgpViewT<stk::mesh::Entity*, NgpMemSpace>;
  request_view_t requests_;
...
class NgpDestroyConnectionT {
 public:
  ...
  KOKKOS_INLINE_FUNCTION FutureDestroyConnection request(our_size_t ticket,
                                                         utils::variant<stk::mesh::Entity, FutureEntity> from_entity,
                                                         utils::variant<stk::mesh::Entity, FutureEntity> to_entity) {
    constexpr auto name = utils::make_string_literal("NgpDestroyConnectionT::request");
    assert_active_space<name>();
    assert_ticket_out_of_range<name>(ticket);
 ...
 private:
  ...
  using request_view_t = utils::NgpViewT<DestroyConnectionRequest*, NgpMemSpace>;
  request_view_t requests_;
  //@}
};  // NgpDestroyConnectionT
